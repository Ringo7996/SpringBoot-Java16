...
public class HomeController {
  ...
  @GetMapping("/text")
  public String demoText(Model model, HttpServletRequest request, HttpSession session) {
    ...
    request.setAttribute("person_from_request",tom);
    session.setAttribute("person_from_session",tom);
    return "text";
  }
