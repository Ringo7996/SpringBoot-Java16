...
public class CourseDB {
    ...
    public static List<Course> courses = new ArrayList<>(List.of(
            Course.builder().withId(1).withName("Java").withDescription("Java description").withType("offline").withCategories(List.of(CategoryDB.categories.get(1))).withThumbnail("java.jpg").withPrice(150000).withRating(4.5).withUserId(1).build(),
