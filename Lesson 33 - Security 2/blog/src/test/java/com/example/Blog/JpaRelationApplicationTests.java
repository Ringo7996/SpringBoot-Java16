...
class JpaRelationApplicationTests {
    ...
    void save_users() {
        ...
        List<User> users = List.of(
                new User(null, "Bùi Hiên", "admin@gmail.com", encoder.encode("111"), null, List.of(adminRole, userRole)),
                new User(null, "Thu Hằng", "author@gmail.com", encoder.encode("111"), null, List.of(authorRole, userRole))
        );
    ...
    @Test
    void test(){
        List<Blog> blogPage = blogRepository.findByUser_Id(1);
